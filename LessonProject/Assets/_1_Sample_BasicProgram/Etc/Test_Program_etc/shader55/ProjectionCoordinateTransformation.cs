...
{
    /// <summary> プロジェクション座標変換の過程を可視化する </summary>
    public class ProjectionCoordinateTransformation : MonoBehaviour
    {
        /// <summary> カメラを原点に固定する想定でメッシュを作る </summary>
        ...
        private void Start() {
            ...
            CreateMesh(mesh, vertices);//メッシュ作成

            //頂点を変化させる
            StartCoroutine(UpdateVertices(vertices, mesh));
        }

        /// <summary>メッシュの作成 </summary>
        ...
        /// <summary> 頂点をカメラの視錐台に合わせた状態に更新する </summary>
